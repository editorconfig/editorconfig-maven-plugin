...
class ByteArrayLineTest {
    ...
    void test_getContent() {
        ...
        // then.
        Assertions.assertThat(first.getContentWithEol())
                .hasSize(6)
                .containsExactly('H', 'e', 'l', 'l', 'o', '\n');
        Assertions.assertThat(second.getContentWithEol())
                .hasSize(6)
                .containsExactly('A', 'l', 'e', 'x', '\r', '\n');
        Assertions.assertThat(third.getContentWithEol())
                .hasSize(4)
                .containsExactly('B', 'B', 'B', '\0');
    }
    ...
    void test_getIndentInColumns_emptyLine() {
        ...
        // when.
        ByteArrayLine sut = new ByteArrayLine(new byte[] {'\n'}, 0, EndOfLine.LINE_FEED);
